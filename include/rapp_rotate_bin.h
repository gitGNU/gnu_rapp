...
#ifndef RAPP_ROTATE_BIN_H
#define RAPP_ROTATE_BIN_H
 ...
 */
RAPP_EXPORT int
rapp_rotate_cw_bin(uint8_t *restrict dst, int dst_dim,
 ...
 */
RAPP_EXPORT int
rapp_rotate_ccw_bin(uint8_t *restrict dst, int dst_dim,
                    const uint8_t *restrict src, int src_dim,
                    int width, int height);
