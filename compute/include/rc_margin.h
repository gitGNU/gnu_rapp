...
/**
 *  @file   rc_margin.h
 *  @brief  RAPP Compute layer binary logical margins.
 */
 ...
 *
 *  @param[out] margin   Margin pixel buffer with at least @e width pixels.
 *  @param[in]  src      Source pixel buffer.
 *  @param      dim      Row dimension of the src buffer.
 ...
 *
 *  @param[out] margin   Margin pixel buffer with at least @e height pixels.
 *  @param[in]  src      Source pixel buffer.
 *  @param      dim      Row dimension of the src buffer.
 *  @param      width    Image width in pixels.
 *  @param      height   Image height in pixels.
